...
Otherwise call `stage_knowledge_transaction` exactly once with the transaction.
The tool revalidates revision and target digests against the live corpus and
